...
# Tak, na podstawie uzyskanych klastrów można wnioskować o ogólnej tematyce dokumentów.
# Chmury słów pokazują zestawy najczęściej używanych wyrażeń w każdej grupie, co pozwala 
# przypisać im określone obszary tematyczne. Na przykład obecność słów takich jak „immigration”
# czy „america” wskazuje na tematykę polityczno-społeczną, natomiast słowa „system” czy „business”
# sugerują kontekst organizacyjny lub zarządczy. 

# 2- Jakich ogólnie obszarów tematycznych dotyczą klastry oraz ile jest tych obszarów?

# Na podstawie najardziej szczegółowego podziału (k=4) można wyróżnić cztery główne obszary tematyczne:
# 1. polityka
# 2. organizacja pracy
# 3. komunikacja codzienna
# 4. badania naukowe
